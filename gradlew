...
#
# The "gradlew" can be used to initialize a Gradle Wrapper (gradlew) for a
# project without needing to manually install Gradle. For more details refer to
...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # temporary variables.  (Echo exits as well as returns an exit code.)
        # See also https://stackoverflow.com/a/22607485
        set -- "$@" "$arg"
        shift
    done
fi
